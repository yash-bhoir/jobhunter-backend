...
// Outreach fallback credentials (used when user has no SMTP configured)
// Use OUTREACH_FROM_EMAIL / OUTREACH_FROM_PASS to avoid colliding with the
// admin portal ADMIN_EMAIL var.  Falls back to SMTP_USER/SMTP_PASS if unset.
const ADMIN_EMAIL = process.env.OUTREACH_FROM_EMAIL || process.env.SMTP_USER || 'yash51217@gmail.com';
const ADMIN_PASS  = process.env.OUTREACH_FROM_PASS  || process.env.SMTP_PASS || '';
